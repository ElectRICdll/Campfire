...
func registerDependencies(engine *gin.Engine) {
	...
	engine.Any("/git/:project_id/:gitPath/*any", git.GitHTTPBackend)
	engine.Handle("PROPFIND", "/git/:project_id/:gitPath/*any", git.GitHTTPBackend)
	engine.Handle("MKCOL", "/git/:project_id/:gitPath/*any", git.GitHTTPBackend)
	engine.Handle("LOCK", "/git/:project_id/:gitPath/*any", git.GitHTTPBackend)
	engine.Handle("UNLOCK", "/git/:project_id/:gitPath/*any", git.GitHTTPBackend)
	engine.Handle("MOVE", "/git/:project_id/:gitPath/*any", git.GitHTTPBackend)
